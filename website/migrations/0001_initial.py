# Generated by Django 3.2.23 on 2024-01-02 23:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_origin', models.DateTimeField()),
                ('time_destination', models.DateTimeField()),
                ('seat', models.CharField(max_length=255)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('city_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='website.city')),
                ('destination_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='website.destination')),
                ('transportation_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='website.transportation')),
